...
static const uint8_t BUFFER_SIZE = 256;  // The maximum size of a single packet (both receive and transmit)
static const uint8_t READ_TIMEOUT = 200;  // The maximum time to wait before considering a packet complete
